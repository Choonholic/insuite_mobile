...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	ccx.m_pNewViewClass	= RUNTIME_CLASS(CDualView);
	m_pView				= DYNAMIC_DOWNCAST(CDualView, this->CreateView(&ccx));
...
void CMainFrame::OnSize(UINT nType, int cx, int cy)
{
	...
	{
		ASSERT((m_pView != NULL) && (m_pView->IsKindOf(RUNTIME_CLASS(CDualView))));
